(function() {
    ...
    var runCommon = function(testcases, validHashtagNamespaces) {
        xpath.yy.xpathmodels = makeXPathModels(makeXPathConfig(validHashtagNamespaces, {}));
    ...
    var runGeneratorTests = function(testcases, translationDict, namespaces) {
        xpath.yy.xpathmodels = makeXPathModels(makeXPathConfig(namespaces, translationDict));
        var parsed;
        for (var i in testcases) {
            if (testcases.hasOwnProperty(i)) {
                try {
    ...
    test("hashtags with no xpath", function() {
        xpath.yy.xpathmodels = makeXPathModels(makeXPathConfig(['form', 'case'], {}));
    ...
    test("from xpath to hashtag", function() {
        ...
        xpath.yy.xpathmodels = makeXPathModels(makeXPathConfig(['form', 'case'], translationDict));
