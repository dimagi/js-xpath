...
case 40: this.$ = $$[$0]; 
break;
case 41: var nodeTest = $$[$0]; // temporary dict with appropriate args
                                          this.$ = new XPathStep(nodeTest); 
break;
case 42: var nodeTest = $$[$0-1];  // temporary dict with appropriate args
...
break;
case 45: this.$ = {"test": XPathTestEnum.NAME, "name": $$[$0]}; 
break;
case 46: this.$ = {"test": XPathTestEnum.NAME_WILDCARD}; 
break;
case 47: this.$ = {"test": XPathTestEnum.NAMESPACE_WILDCARD}; 
break;
case 48: this.$ = {"test": XPathTestEnum.TYPE_NODE}; 
break;
case 49: this.$ = {"test": XPathTestEnum.TYPE_TEXT}; 
break;
case 50: this.$ = {"test": XPathTestEnum.TYPE_COMMENT}; 
break;
case 51: this.$ = {"test": XPathTestEnum.TYPE_PROCESSING_INSTRUCTION, "literal": $$[$0-1]}; 
break;
