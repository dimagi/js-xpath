...
break;
case 5: this.begin("OP_CONTEXT"); yy_.yytext = yy_.yytext.substr(1,yy_.yyleng-1); return "VAR"; 
break;
case 6: this.begin("OP_CONTEXT"); 
                                     yy_.yytext = yy_.yytext.substr(0, yy_.yyleng-2);
                                     return "NSWILDCARD"; 
break;
case 7: this.begin("OP_CONTEXT"); return "QNAME"; 
break;
case 8: this.begin("OP_CONTEXT"); return "WILDCARD"; 
break;
case 9: this.begin("VAL_CONTEXT"); return "MULT"; 
break;
case 10: this.begin("VAL_CONTEXT"); return "AND"; 
break;
case 11: this.begin("VAL_CONTEXT"); return "OR"; 
break;
case 12: this.begin("VAL_CONTEXT"); return "DIV"; 
break;
case 13: this.begin("VAL_CONTEXT"); return "MOD"; 
break;
case 14: this.begin("OP_CONTEXT"); return "NUM"; 
break;
case 15: this.begin("VAL_CONTEXT"); return "EQ"; 
break;
case 16: this.begin("VAL_CONTEXT"); return "NEQ"; 
break;
case 17: this.begin("VAL_CONTEXT"); return "LTE"; 
break;
case 18: this.begin("VAL_CONTEXT"); return "LT"; 
break;
case 19: this.begin("VAL_CONTEXT"); return "GTE"; 
break;
case 20: this.begin("VAL_CONTEXT"); return "GT"; 
break;
case 21: this.begin("VAL_CONTEXT"); return "PLUS"; 
break;
case 22: this.begin("VAL_CONTEXT"); return "MINUS"; 
break;
case 23: this.begin("VAL_CONTEXT"); return "UNION"; 
break;
case 24: this.begin("VAL_CONTEXT"); return "DBL_SLASH"; 
break;
case 25: this.begin("VAL_CONTEXT"); return "SLASH"; 
break;
case 26: this.begin("VAL_CONTEXT"); return "LBRACK"; 
break;
case 27: this.begin("OP_CONTEXT");  return "RBRACK"; 
break;
case 28: this.begin("VAL_CONTEXT"); return "LPAREN"; 
break;
case 29: this.begin("OP_CONTEXT");  return "RPAREN"; 
break;
case 30: this.begin("OP_CONTEXT");  return "DBL_DOT"; 
break;
case 31: this.begin("OP_CONTEXT");  return "DOT"; 
break;
case 32: this.begin("VAL_CONTEXT"); return "AT"; 
break;
case 33: this.begin("VAL_CONTEXT"); return "DBL_COLON"; 
break;
case 34: this.begin("VAL_CONTEXT"); return "COMMA"; 
break;
...
lexer.rules = [/^[\s+]/,/^node(?=([\s+]?\())/,/^text(?=([\s+]?\())/,/^comment(?=([\s+]?\())/,/^processing-instruction(?=([\s+]?\())/,/^\$[A-Za-z_][A-Za-z0-9._-]*(:[A-Za-z_][A-Za-z0-9._-]*)?/,/^[A-Za-z_][A-Za-z0-9._-]*:\*/,/^[A-Za-z_][A-Za-z0-9._-]*(:[A-Za-z_][A-Za-z0-9._-]*)?/,/^\*/,/^\*/,/^and\b/,/^or\b/,/^div\b/,/^mod\b/,/^[0-9]+(\.[0-9]*)?|\.[0-9]+/,/^=/,/^!=/,/^<=/,/^</,/^>=/,/^>/,/^\+/,/^-/,/^\|/,/^\/\//,/^\//,/^\[/,/^\]/,/^\(/,/^\)/,/^\.\./,/^\./,/^@/,/^::/,/^,/,/^"[^"\""]*"|'[^'\'']*'/,/^$/];
