...
break;
case 43: this.$ = {"expr": "axis", "val": $$[$0-1]}; 
break;
case 44: this.$ = "new Integer(XPathStep.AXIS_ATTRIBUTE)"; 
break;
case 45: this.$ = {"expr": "node_test", "class": "NAME", "val": $$[$0]}; 
break;
case 46: this.$ = {"expr": "node_test", "class": "WILDCARD"}; 
break;
case 47: this.$ = {"expr": "node_test", "class": "NSWILDCARD"}; 
break;
case 48: this.$ = {"expr": "node_test", "class": "NODE"}; 
break;
case 49: this.$ = {"expr": "node_test", "class": "TEXT"}; 
break;
case 50: this.$ = {"expr": "node_test", "class": "COMMENT"}; 
break;
case 51: this.$ = {"expr": "node_test", "class": "PROCESSING_INSTRUCTION", "val": $$[$0-1]}; 
break;
case 52: this.$ = {"expr": "str", "val": $$[$0]}; 
break;
case 53: this.$ = {"expr": "num", "val": Number($$[$0])}; 
break;
}
},
